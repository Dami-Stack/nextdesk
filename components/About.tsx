...
const About = () => {
  return (
    <section id="about"  className="w-full px-6 py-20 bg-[var(--background)] text-[var(--foreground)]">
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12">
        ...
        <div className="relative group overflow-hidden rounded-lg shadow-lg">
          ...
          <div className="absolute inset-0 bg-black/50 flex flex-col justify-center items-center text-white px-6">
            ...
            <p className="text-lg leading-relaxed text-center max-h-0 overflow-hidden opacity-0 group-hover:max-h-[500px] group-hover:opacity-100 transition-all duration-700 ease-in-out z-10">
