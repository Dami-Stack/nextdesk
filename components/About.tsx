      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12">
        ...
        >
          ...
          <div className="absolute inset-0 bg-black/50 flex flex-col justify-center items-center text-white px-6">
            ...
            <p
              className={`leading-relaxed text-center max-h-0 overflow-hidden opacity-0 
              group-hover:max-h-[600px] group-hover:opacity-100 transition-all duration-700 ease-in-out z-10
              ${showText1 ? "max-h-[600px] opacity-100" : ""} 
              text-xs sm:text-sm md:text-lg`} // Smaller on mobile, scales up
            >
        ...
        >
          ...
          <div className="absolute inset-0 bg-black/50 flex flex-col justify-center items-center text-white px-6">
            ...
            <p
              className={`leading-relaxed text-center max-h-0 overflow-hidden opacity-0 
              group-hover:max-h-[600px] group-hover:opacity-100 transition-all duration-700 ease-in-out z-10
              ${showText2 ? "max-h-[600px] opacity-100" : ""} 
              text-xs sm:text-sm md:text-lg`} // Smaller on mobile, scales up
            >
